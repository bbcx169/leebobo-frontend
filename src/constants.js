...
export const products = [
  ...
  { id: 6, name: '蕃茄', price: 35, tags: ['經典必吃'], description: '傳承古法手工熬製，金黃糖衣薄脆不黏牙，包裹優選鮮果，口口香甜多汁。完美呈現外脆內軟的經典滋味，快來攤位帶走這份紅亮誘人的傳統甜蜜！', image: 'https://lh3.googleusercontent.com/d/1HGqX5CBSbDzPfTpm7eJ4BasLfUOSy8Sc?auto=format&fit=crop&q=80&w=400' },
  { id: 7, name: '蕃茄蜜餞', price: 40, tags: ['人氣首選'], description: '古法熬製糖衣薄脆不黏牙，包裹多汁蕃茄與鹹甜蜜餞。咬下瞬間，金黃糖衣與鮮果層次迸發，酸甜解膩且外脆內軟。這份傳承傳統的手工滋味，是絕不能錯過的紅亮誘惑，快來攤位品嚐！', image: 'https://lh3.googleusercontent.com/d/1FTgNOznOCkeVxHzOsFfTX9kFnGdXgDv1?auto=format&fit=crop&q=80&w=400' },
  { id: 8, name: '鳥梨', price: 60, tags: ['傳統風味', '季節限定'], description: '重溫夜市經典！嚴選優質鳥梨，遵循古法手工熬製糖衣，金黃外殼亮麗酥脆，果肉酸甜回甘且質地軟嫩。咬下一口，讓這份最道地的傳統風味，帶您回味童年園遊會的單純美好！', image: 'https://lh3.googleusercontent.com/d/146FTkRZCHmSgH3RKanKy4xMvErZoRWt-?auto=format&fit=crop&q=80&w=400' }
];
