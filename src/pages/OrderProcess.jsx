...
const OrderProcess = ({ navigateTo }) => {
    ...
    const faqCategories = [
        ...
        { 
            category: "🚚 配送與取貨", 
            items: [
                { q: "運費如何計算？", a: "臺北市與新北市：商品金額滿 $5,000 元（不含掃帚租押金）享免運；未達門檻則酌收 $350 元運費。外縣市：目前受限於物流品質，暫不提供宅配，需由顧客配合自取。" }, 
        ...
        { 
            ...
            items: [
                ...
                // 💡 顧問修正：新增關於婚禮為什麼需要雙收貨人的 FAQ
                { q: "為什麼婚宴訂單需要提供兩位收貨人的聯絡資訊？", a: "婚宴當日新人行程緊湊且現場環境較為嘈雜，常有漏接物流電話的情況。為確保糖葫蘆能在指定時間順利送達，避免延誤您的流程，我們強烈建議提供兩位現場代收親友（如：伴郎、總召或工作人員）的聯絡電話，讓您能安心享受專屬於您的美好時刻！🍡" },
